...
| `rgp_cluster` | Cluster RGPs across genomes based on their shared gene families, using a Gene Repertoire Relatedness (GRR) score.                                                                                                          | [RGP clustering](./RGP/rgpAnalyses.html#rgp-clustering) |
...
| Command          | Description                                                                        | Documentation                                                    |
|------------------|------------------------------------------------------------------------------------|------------------------------------------------------------------|
| `metrics`        | Compute pangenome metrics such as genomic fluidity.                                | [Pangenome metrics](./PangenomeAnalyses/pangenomeAnalyses.html#pangenome-metrics)        |
