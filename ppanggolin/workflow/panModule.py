...
def launch(args: argparse.Namespace):
    ...
    compute_neighbors_graph(pangenome, graph_args.remove_high_copy_number, 
                            args.force, disable_bar=args.disable_prog_bar)
    ...
    predict_modules(pangenome=pangenome, tmpdir=args.tmpdir, cpu=args.cpu, dup_margin=module_args.dup_margin, size=module_args.size,
                min_presence=module_args.min_presence, transitive=module_args.transitive, jaccard=module_args.jaccard, force=args.force,
                disable_bar=args.disable_prog_bar)
