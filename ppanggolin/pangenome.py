...
class Pangenome:
    ...
    def get_module(self, module_id: str) -> Spot:
        ...
        try:
            ...
            return self.get_module(module_id)  # return what was expected. If geneID does not exist it will raise an error.
        except KeyError:
    ...
    def get_rgp_by_metadata(self, value: str = None, accession: str = None) -> Generator[Region, None, None]:
        ...
        for rgp in self.regions:
            if len(list(rgp.get_metadata(value=value, accession=accession))) > 0:
                yield rgp
    ...
    def get_spots_by_metadata(self, value: str = None, accession: str = None) -> Generator[Spot, None, None]:
        """ Get rgp famlies with a specific annotation or source in pangenome
        ...
        for spot in self.spots:
            if len(list(spot.get_metadata(value=value, accession=accession))) > 0:
                yield spot
