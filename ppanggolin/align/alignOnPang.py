...
def alignSubparser(subparser):
    parser = subparser.add_parser("align",help = "aligns proteins to the pangenome gene families representatives", formatter_class=argparse.ArgumentDefaultsHelpFormatter)
